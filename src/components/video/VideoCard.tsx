    ...
    >
      ...
      <div className="flex flex-col flex-grow p-5">
        ...
        <Link
          ...
          className="mt-auto flex items-center justify-center w-full py-2.5 rounded-xl bg-muted/50 hover:bg-primary hover:text-white font-medium text-sm transition-colors duration-300 border border-border/50"
        >
          Watch Now
        </Link>
      </div>
